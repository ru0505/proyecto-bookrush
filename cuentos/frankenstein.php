...
<head>
    ...
    <meta charset="UTF-8">
    <title>EL MONSTRUO DE FRANKENSTEIN</title>
    <style>
        body {
            font-family: 'Segoe UI', sans-serif;
            background-color: #499c49ff;
            color: #ffffffff;
            margin: 0;
            padding: 0;
...
<body>
    ...
    <h1>EL MONSTRUO DE FRANKENSTEIN</h1>

    <div class="contenedor">
        <div class="imagen">
            <img src="../imagenes/frankdentro.jpg" alt="EL MONSTRUO DE FRANKENSTEIN">
        </div>
