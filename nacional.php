...
// Obtener puntaje y respuestas desde progreso_usuario
if ($id_usuario) {
...
// Puntaje por DNI (reemplaza si hay datos aquí)
if ($dni) {
...
<body>
  ...
  <div class="top-bar">
    <div style="display: flex; align-items: center; gap: 15px;">
      <img src="imagenes/LOGO_BOOK_RUSH.png" alt="BookRush Logo" style="width: 50px; height: 50px; object-fit: contain;">
      <h1>BookRush</h1>
    </div>
        ...
        <div class="top-icons">
          <div class="icon-container">
            ...
            <div class="tooltip">
              ...
              Puntos: <?= $puntaje ?><br>
              Preguntas: <?= $total_respondidas ?>
            </div>
          </div>
          <div class="icon-container">
            <a href="total.php">
              <img src="imagenes/estrella.png" alt="Puntos" class="icon">
            </a>
            <div class="tooltip">
              <strong>Mis Puntos</strong><br>
              Total acumulado: <?= $puntaje ?> pts<br>
              <ul>
                <li>Respuestas correctas</li>
                <li>Progreso por libro</li>
                <li>Ranking personal</li>
              </ul>
            </div>
          </div>
          <div class="icon-container">
            <img src="imagenes/puerta.png" alt="Salir" class="icon icon-logout" onclick="confirmarLogout()">
            <div class="tooltip">
              <strong>Cerrar Sesión</strong><br>
              Salir de tu cuenta<br>
  ...
  <header>
    <nav>
      <a href="nacional.php" style="background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%);">Literatura Nacional</a>
  ...
  <div id="confirmacion-modal" class="modal" style="display: none;">
    <div class="modal-content">
      ...
      <p>Se guardará todo tu progreso automáticamente.</p>
      <button onclick="logout()" class="confirmar">Sí, cerrar sesión</button>
  ...
  <script>
    ...
    document.getElementById('confirmacion-modal').addEventListener('click', function(event) {
