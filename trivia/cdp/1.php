...
// Reiniciar puntajes solo si es la primera pregunta
if ($id_pregunta == 1) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Verificar si ya se registró esta pregunta
    $stmt = $conn->prepare("SELECT 1 FROM puntajes WHERE dni = ? AND capitulo = ? AND id_pregunta = ?");
  ...
  <script>
    ...
    function enviarRespuesta(respuesta) {
      ...
      .then(data => {
        ...
        // Redirigir a la siguiente pregunta (2.php)
        setTimeout(() => {
